    ...
    <div className="space-y-5">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 font-medium">
              {Object.values(stageData).reduce((s, a) => s + a.length, 0)} leads across {stages.length} project statuses
            </p>
          </div>
        </div>
      </div>
      ...
      {isPending ? (
        ...
        <PipelineGridBoard
          stages={stages}
          stageData={stageData}
          renderCard={(lead) => <ProjectPipelineCard lead={lead} lifecycleStatusGroups={lifecycleStatusGroups} />}
        />
      ) : (
