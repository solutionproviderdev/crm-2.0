...
export const metadata = {
  title: "Client Pipeline | EaseIT CRM",
  description: "Sales-stage leads grouped by pipeline stage",
};

async function ClientPipelinePageContent() {
...
function ClientPipelineSkeleton() {
  return (
...
export default function ClientPipelinePage() {
  return (
    <div className="mx-auto py-8 px-4 w-full">
      <Suspense fallback={<ClientPipelineSkeleton />}>
        <ClientPipelinePageContent />
      </Suspense>
    </div>
  );
}
